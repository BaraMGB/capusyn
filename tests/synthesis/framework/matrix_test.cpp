...
void MatrixTest::runTest() {
  beginTest("Transpose");
  capusyn::poly_float row0(1.0f, 2.0f, 3.0f, 4.0f);
  capusyn::poly_float row1(5.0f, 6.0f, 7.0f, 8.0f);
  capusyn::poly_float row2(9.0f, 10.0f, 11.0f, 12.0f);
  capusyn::poly_float row3(13.0f, 14.0f, 15.0f, 16.0f);
  capusyn::matrix matrix(row0, row1, row2, row3);
  matrix.transpose();
