...
void PolyValuesTest::runFloatTests() {
  capusyn::poly_float one(1.0f, 2.0f, 3.0f, 4.0f);
  capusyn::poly_float two(9.0f, 11.0f, 13.0f, 15.0f);

  beginTest("Floats Add");
  capusyn::poly_float add = one + two;
  expect(add[0] == 10.0f);
  expect(add[1] == 13.0f);
  expect(add[2] == 16.0f);
  expect(add[3] == 19.0f);
  ...
  capusyn::poly_float subtract = one - two;
  ...
  capusyn::poly_float multiply = one * two;
  ...
  capusyn::poly_mask compare_mask = capusyn::poly_float::greaterThan(one, one);
  expect(compare_mask[0] == 0);
  expect(compare_mask[1] == 0);
  expect(compare_mask[2] == 0);
  expect(compare_mask[3] == 0);
  compare_mask = capusyn::poly_float::lessThan(one, one);
  expect(compare_mask[0] == 0);
  expect(compare_mask[1] == 0);
  expect(compare_mask[2] == 0);
  expect(compare_mask[3] == 0);

  compare_mask = capusyn::poly_float::equal(one, one);
  ...
  capusyn::poly_float one_plus1 = one + 1;
  expect(one_plus1[0] == 2.0f);
  expect(one_plus1[1] == 3.0f);
  expect(one_plus1[2] == 4.0f);
  expect(one_plus1[3] == 5.0f);
  capusyn::poly_mask greater_mask1 = capusyn::poly_float::greaterThan(one_plus1, one);
  ...
  capusyn::poly_float neg0(-5, -5, -2, 0);
  capusyn::poly_float neg1(-10, -5, 1, -1);
  capusyn::poly_mask greater_mask2 = capusyn::poly_float::greaterThan(neg0, neg1);
  ...
  capusyn::poly_float to_sum(1.0f, -2.0f, 3.0f, -4.0f);
  expect(to_sum.sum() == -2.0f);
}

void PolyValuesTest::runIntTests() {
  capusyn::poly_int one(1, 2, 3, 4);
  capusyn::poly_int two(9, 11, 13, 15);
  ...
  capusyn::poly_int negatives(-10, 3, -3, -9);
  ...
  capusyn::poly_int wrap = (unsigned int)-2;
  wrap += 5;
  expect(wrap[0] == 3);
  expect(wrap[1] == 3);
  expect(wrap[2] == 3);
  ...
  capusyn::poly_int subtract = two - one;
  expect(subtract[0] == 8);
  expect(subtract[1] == 9);
  ...
  capusyn::poly_int multiply = one * two;
  expect(multiply[0] == 9);
  ...
  capusyn::poly_int negate = (unsigned int)-5;
  capusyn::poly_int negated = -negate;
  expect(negated[0] == 5);
  expect(negated[1] == 5);
  expect(negated[2] == 5);
  expect(negated[3] == 5);
  ...
  capusyn::poly_mask compare1 = capusyn::poly_int::equal(one, two);
  expect(compare1[0] == 0);
  expect(compare1[1] == 0);
  expect(compare1[2] == 0);
  expect(compare1[3] == 0);

  capusyn::poly_int test_equal0(-1, 5, -10, 5);
  capusyn::poly_int test_equal1(1, -5, -10, 5);

  capusyn::poly_mask compare2 = capusyn::poly_int::equal(test_equal0, test_equal1);
  expect(compare2[0] == 0);
  expect(compare2[1] == 0);
  expect(compare2[2] == (unsigned int)-1);
  expect(compare2[3] == (unsigned int)-1);

  capusyn::poly_mask compare3 = capusyn::poly_int::equal(test_equal1, test_equal1);
  ...
  capusyn::poly_mask equal_mask = capusyn::poly_int::greaterThan(one, one);
  expect(equal_mask[0] == 0);
  expect(equal_mask[1] == 0);
  expect(equal_mask[2] == 0);
  expect(equal_mask[3] == 0);

  capusyn::poly_int one_plus1 = one + 1;
  expect(one_plus1[0] == 2);
  expect(one_plus1[1] == 3);
  expect(one_plus1[2] == 4);
  expect(one_plus1[3] == 5);
  capusyn::poly_mask greater_mask1 = capusyn::poly_int::greaterThan(one_plus1, one);
  expect(greater_mask1[0] == (unsigned int)-1);
  expect(greater_mask1[1] == (unsigned int)-1);
  expect(greater_mask1[2] == (unsigned int)-1);
  expect(greater_mask1[3] == (unsigned int)-1);

  capusyn::poly_int neg0(-5, -5, -2, 0);
  capusyn::poly_int neg1(-10, -5, 1, -1);
  capusyn::poly_mask greater_mask2 = capusyn::poly_int::greaterThan(neg0, neg1);
  expect(greater_mask2[0] == (unsigned int)-1);
  expect(greater_mask2[1] == 0);
  ...
  beginTest("Ints Sum");
  capusyn::poly_int to_sum(1, -2, 3, -4);
  expect(to_sum.sum() == (unsigned int)-2);

  beginTest("Detect Mask");
  capusyn::poly_float compare(1.0f, -2.0f, 3.0f, -4.0f);
  capusyn::poly_mask compare_mask = capusyn::poly_float::greaterThan(compare, 2.0f);
  expect(capusyn::poly_float::greaterThan(compare, 2.0f).anyMask() != 0);
  expect(capusyn::poly_float::lessThan(compare, -3.5f).anyMask() != 0);
  expect(capusyn::poly_float::equal(compare, 1.0f).anyMask() != 0);
  expect(capusyn::poly_float::equal(compare, -2.0f).anyMask() != 0);
  expect(capusyn::poly_float::equal(compare, 5.0f).anyMask() == 0);
}
