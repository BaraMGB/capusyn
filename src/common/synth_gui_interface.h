...
struct SynthGuiData {
  ...
  capusyn::control_map controls;
  capusyn::output_map mono_modulations;
  capusyn::output_map poly_modulations;
  capusyn::output_map modulation_sources;
  WavetableCreator* wavetable_creators[capusyn::kNumOscillators];
  SynthBase* synth;
};
...
class SynthGuiInterface {
  public:
    ...
    virtual void updateGuiControl(const std::string& name, capusyn::mono_float value);
    capusyn::mono_float getControlValue(const std::string& name);
